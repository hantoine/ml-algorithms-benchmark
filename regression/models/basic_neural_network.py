...
class BasicNeuralNetworkModel(NonTreeBasedModel):
    ...
    def build_estimator(args, train_data=None, test=False):
        return MLPRegressor(
            random_state=RANDOM_STATE, max_iter=(1 if test else 300), **args
        )
